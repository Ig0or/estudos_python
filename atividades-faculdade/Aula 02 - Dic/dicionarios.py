...
def conta_telefones(agenda):
    qtd = 0
    for pessoa in agenda:
        if agenda[pessoa]["telefones"]:
            print(agenda[pessoa]["telefones"])
...
class TestPartOne(unittest.TestCase):
    ...
    def test_04_conta_letras(self):
        ...
        self.assertEqual(
            conta_letras("a" * 5 + "b" * 3 + "c" * 10 + "a"), {"a": 6, "b": 3, "c": 10}
        )

    def test_05_email(self):
        self.assertEqual(
            email(agenda_melhor1, "lucas"), "lucas.goncalves@faculdadeimpacta.com.br"
        )
    ...
    def test_09_conta_ocorrencias(self):
        ...
        self.assertEqual(
            conta_ocorrencias(agenda3), {1123232323: 4, 11777888999: 1, 1122222222: 1}
        )
